...
check_code:
	@flake8 scripts/* getthevibe_api/*.py

black:
	@black scripts/* getthevibe_api/*.py
...
clean:
	...
	@rm -fr build dist
	@rm -fr getthevibe_api-*.dist-info
	@rm -fr getthevibe_api.egg-info
...
LOCAL_PATH="raw_data/fer2013.csv"
